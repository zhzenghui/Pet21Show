...
- (IBAction)saveClipImage:(id)sender
{
...
//    [data writeToFile:@"/Users/arturgrigor/Documents/image.jpg" atomically:YES];
    [delegate saveImage:simpleImageEditorView.output];
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.rightBarButtonItem  = BARBUTTON(NSLocalizedString(@"保存", @""), @selector(saveClipImage:));
    ...
    ratioSegmentedControl = [[UISegmentedControl alloc] initWithItems:[NSArray arrayWithObjects:@"None", @"1:1", @"3:2", @"16:10", @"18:10", nil]];
    ...
    simpleImageEditorView.ratio  = 4./4.;
}
...
- (void)arrangeItemsForInterfaceOrientation:(UIInterfaceOrientation)forInterfaceOrientation
{
    ...
    CGFloat width = bounds.size.width, height = bounds.size.height -44;
