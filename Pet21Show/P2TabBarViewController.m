...
#import "P2TabBarViewController.h"
...
@interface P2TabBarViewController ()

@end

@implementation P2TabBarViewController
@synthesize tabBar;
...
- (void) awakeFromNib
{
    ...
    P2OnLineViewController *detailController1 = [[[P2OnLineViewController alloc] init] autorelease];
    
    P2PaysViewController *detailController2 = [[[P2PaysViewController alloc] init] autorelease];
    
    P2UserViewController *detailController3 = [[[P2UserViewController alloc] init] autorelease];
    
    P2UserHomeViewController *detailController4 = [[[P2UserHomeViewController alloc] init] autorelease];
    
    P2SettingViewController *detailController5 = [[[P2SettingViewController alloc] init] autorelease];
    
    tabBarItems = [[NSArray arrayWithObjects:
                    [NSDictionary dictionaryWithObjectsAndKeys:@"TabBar-Glyph-Friends.png", @"image", detailController1, @"viewController", nil],
                    [NSDictionary dictionaryWithObjectsAndKeys:@"TabBar-Glyph-Activity.png", @"image", detailController3, @"viewController", nil],
                    [NSDictionary dictionaryWithObjectsAndKeys:@"TabBar-Glyph-Profile.png", @"image", detailController2, @"viewController", nil],
                    
                    [NSDictionary dictionaryWithObjectsAndKeys:@"111-user.png", @"image", detailController4, @"viewController", nil],
                    [NSDictionary dictionaryWithObjectsAndKeys:@"TabBar-Glyph-Thumbs.png", @"image", detailController5, @"viewController", nil], nil] retain];
}
...
- (void)viewDidLoad
{
    ...
    self.tabBar = [[[P2CustomTabBar alloc] initWithItemCount:tabBarItems.count itemSize:CGSizeMake(self.view.frame.size.width/tabBarItems.count, tabBarGradient.size.height*2) tag:0 delegate:self] autorelease];
...
{
    NSDictionary *dict = [tabBarItems objectAtIndex:itemIndex];
    NSString *path = [dict objectForKey:@"image"];
                      
    [path stringByReplacingOccurrencesOfString:@".png" withString:@"-Active.png"];
    return [UIImage imageNamed:[dict objectForKey:@"image"]];
}
