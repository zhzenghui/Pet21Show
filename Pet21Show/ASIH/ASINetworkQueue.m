...
- (void)addHEADOperation:(NSOperation *)operation validatesSecureCertificate:(BOOL)validatesSecureCertificate
{
	...
	if ([operation isKindOfClass:[ASIHTTPRequest class]]) {
		...
		if (showAccurateProgress) {
			...
			if ([[request requestMethod] isEqualToString:@"GET"]) {
				...
				[self addHEADOperation:HEADRequest validatesSecureCertificate:request.validatesSecureCertificate];
